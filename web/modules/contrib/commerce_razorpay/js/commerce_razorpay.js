...
console.log(settings);
	  ...
	  var contact = settings.commerce_razorpay.contact;
      var options = {
        'key': key,
        ...
        'handler': function(response) {
          window.location = '/budweiser-cms/capture-payment?amount=' + amount + '&order_id=' + commerce_order_id + '&payment_settings=' + payment_settings + '&response=' + JSON.stringify(response);
        },
        'prefill': {
          'name': name,
          'email': email,
